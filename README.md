...
Example of `figma-export.yaml` file for Flutter project — [Sources/FigmaExport/Resources/flutterConfig.swift](./Sources/FigmaExport/Resources/flutterConfig.swift)
